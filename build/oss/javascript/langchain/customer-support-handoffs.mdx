...
- Learn about the [supervisor pattern](/oss/javascript/langchain/supervisor) for centralized orchestration
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/customer-support-handoffs.mdx)
</Callout>
