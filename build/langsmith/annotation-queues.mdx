...
1. Submit the form to create the queue. LangSmith immediately pairs runs from the two experiments and populates the queue; there is no separate populate step.
    ...
    ![Pairwise creation pane.](/langsmith/images/pairwise-annotation-queue-create-form.png)
...
If you prefer to populate a PAQ later or via automation, you can create an empty queue under **Annotation queues** → **Pairwise** and [use automation rules](/langsmith/rules) to add comparisons incrementally.
