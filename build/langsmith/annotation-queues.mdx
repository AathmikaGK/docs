...
In the [LangSmith UI](https://smith.langchain.com/), single-run queues can be created directly from the **Annotation queues** section. Pairwise queues must be created from the **Datasets & Experiments** pages, where you select the experiments to compare.
