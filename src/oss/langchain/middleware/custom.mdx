...
<CardGroup cols={2}>
  <Card title="Decorator-based middleware" icon="gear" href="#decorator-based-middleware">
    Quick and simple for single-hook middleware. Use decorators to wrap individual functions.
  </Card>
  <Card title="Class-based middleware" icon="gears" href="#class-based-middleware">
